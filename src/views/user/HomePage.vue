...
<section class="container py-5">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="1000">
      <img src="../../assets/images/img/products.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="1000">
      <img src="../../assets/images/img/subscribe.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="1000">
      <img src="../../assets/images/img/products.jpg" class="d-block w-100" alt="...">
    </div>
  ...
  <section class="container py-5">
    <div class="row flex-row-reverse g-3 ">
      <div class="col-lg-6">
        <img src="../../assets/images/img/products.jpg" alt="餅乾" class="w-100" />
      </div>
  ...
  <section class="container py-5">
    <div class="row flex-row g-3 ">
      <div class="col-lg-6">
        <img src="../../assets/images/img/coupon.jpg" alt="餅乾" class="w-100" />
      </div>
